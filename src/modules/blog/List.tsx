...
function BlogList() {
  ...
  function filterByTitle(projects: Blog[], search = '') {
  ...
  function getFilteredBlogs() {
    return filterByTitle(blogsData, query)
  }
    ...
    <section className="py-5 sm:py-10 mt-5 sm:mt-10">
      ...
      <div className="mt-10 sm:mt-16">
        <h3 className="font-general-regular text-center text-secondary-dark dark:text-ternary-light text-md sm:text-xl mb-3 ">
          Here is few articles about web development.
        </h3>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 mt-6 sm:gap-5">
